...
Element1::Element1(){}
Element1::Element1(ElementType type) : type(type) { }

Element1::operator ElementType() const { return type; }
 bool Element1::operator == (Element1 el) const { return type == el.type; }
 bool Element1::operator != (Element1 el) const { return type != el.type; }    
 bool Element1::operator == (ElementType elType) const { return type == elType; }
 bool Element1::operator != (ElementType elType) const { return type != elType; }
